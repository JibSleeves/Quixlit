...
export function RetroWindow({ title, children, className, titleBarClassName, contentClassName }: RetroWindowProps) {
  return (
    ...
    >
      <div
        className={cn(
          'flex items-center justify-between p-1 bg-secondary text-secondary-foreground border-b-2 border-b-[hsl(var(--border-dark))] cursor-default',
          titleBarClassName
        )}
      >
        <span className="font-bold select-none ml-1">{title}</span>
        <div className="flex space-x-1">
          <button className="p-0.5 bg-muted border border-t-[hsl(var(--border-light))] border-l-[hsl(var(--border-light))] border-b-[hsl(var(--border-dark))] border-r-[hsl(var(--border-dark))] active:border-t-[hsl(var(--border-dark))] active:border-l-[hsl(var(--border-dark))] active:border-b-[hsl(var(--border-light))] active:border-r-[hsl(var(--border-light))]">
            <Minus size={14} />
          </button>
          <button className="p-0.5 bg-muted border border-t-[hsl(var(--border-light))] border-l-[hsl(var(--border-light))] border-b-[hsl(var(--border-dark))] border-r-[hsl(var(--border-dark))] active:border-t-[hsl(var(--border-dark))] active:border-l-[hsl(var(--border-dark))] active:border-b-[hsl(var(--border-light))] active:border-r-[hsl(var(--border-light))]">
            <Square size={14} />
          </button>
          <button className="p-0.5 bg-destructive text-destructive-foreground border border-t-[hsl(var(--border-light))] border-l-[hsl(var(--border-light))] border-b-[hsl(var(--border-dark))] border-r-[hsl(var(--border-dark))] active:border-t-[hsl(var(--border-dark))] active:border-l-[hsl(var(--border-dark))] active:border-b-[hsl(var(--border-light))] active:border-r-[hsl(var(--border-light))]">
            <X size={14} />
          </button>
        </div>
      </div>
